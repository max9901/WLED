...
id="btns"></div>Touch threshold: <input type="number" class="s" min="0" 
max="100" name="TT" required><br>IR GPIO: <input type="number" min="-1" 
...
Multi RGBW</option><option value="7">
Segments Effect</option></select><br><a 
